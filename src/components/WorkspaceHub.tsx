      ...
      {!user ? (
        <div className="p-8 rounded-2xl bg-slate-900 border border-white/5 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="space-y-1.5 max-w-lg text-center md:text-left">
            ...
            <h3 className="text-xl font-bold text-white font-sans flex items-center justify-center md:justify-start gap-1.5">
              <Cloud className="w-5 h-5 text-cyan-400" /> Continue to Google Workspace Integration
            </h3>
            <p className="text-xs text-slate-400 leading-normal">
              Authorize secure operations linked with Google Drive and Google Chat with permission from you to browse files, save telemetry snapshots, and broadcast live alerts directly onto your company channels.
            </p>
          </div>
            ...
            <div className="p-5 rounded-2xl bg-slate-900/40 border border-white/5 flex flex-col gap-4 font-sans h-[650px] justify-between">
              <div className="space-y-4">
                ...
                <div className="p-3 rounded-xl bg-slate-950/80 border border-white/5 flex-1 flex flex-col justify-between h-[250px]">
                  <div className="h-full overflow-y-auto space-y-2 text-xs max-h-[230px] pr-1">
